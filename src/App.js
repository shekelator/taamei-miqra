  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <Phrase hebrew="מֻנַ֣ח תְּלִשָה֩ קַדְמָ֨ה מַהְפַּ֤ךְ פַּשְטָא֙ מֻנַ֣ח זָקֵ֔ף" audioFile="munach-telisha-kadma-mahpakh-pashta-munach-zakef.mp3" />
